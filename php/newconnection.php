  ...
  if(isset($_POST['newconnectionSubmit'])){
    ...
    //if($response->success == 1) {
        ...
        if($address_from == 'Use Current Location') {
          $newconnection_address = $_POST['planpopupform_1_a'] ?? '';
          $newconnection_landmark = $_POST['planpopupform_1_l'] ?? '';
          $newconnection_pincode = $_POST['planpopupform_1_p'] ?? '';
        }
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://alliancebroadband.co.in/alliance-spreadsheet/new-connection.php',
        ...
        <div class="wrapper">
          ...
          if (!$mail_1->send()) {
            ...
            header("Location: ../thank-you-new-connection/?id=".$lastid);
            // echo '<script>
            // 	$(document).ready(function () {
            //     $("#feed_suc").show();
            //   });</script>';
