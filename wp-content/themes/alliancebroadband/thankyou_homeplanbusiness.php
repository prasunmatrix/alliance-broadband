<?php
/**
 * Template Name: Thank You Home Plan Business
 */
    ...
    <div class="container">
       ...
       <center>
        ...
        <?php
          global $wpdb;
          $id=$_REQUEST['id'];
          $resultConnection = $wpdb->get_results("SELECT hop.*,cm.city_name,pm.* from wp_homeofficeplan as hop INNER JOIN wp_city_master as cm ON hop.city_id=cm.id INNER JOIN wp_plan_master as pm ON hop.plan_id=pm.id WHERE hop.id='$id'");
          // echo "<pre>";
