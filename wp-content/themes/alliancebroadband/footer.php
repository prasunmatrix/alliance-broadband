...
<script>
  ...
  function createCaptcha3() {
    ...
    //storing captcha so that can validate you can save it somewhere else according to your specific requirements
    code3 = captcha.join("");
    document.getElementById("captcha3").appendChild(canv); // adds the canvas to the body element
  }
...
function validateHomePlan() {
  ...
  var cpatchaTextBox=$("#cpatchaTextBox").val();
  ...
  if(cpatchaTextBox.replace(/\s/g, "").length == 0)
  {
    err++;
    $("#cpatchaTextBox_msg").html("Please enter your cpatcha");
    return false;
  }
  else
  {
    $('#cpatchaTextBox_msg').html('');    
  }
  if(cpatchaTextBox != code)
  {
    err++;
    $("#cpatchaTextBox_msg").html("Invalid Captcha. try Again");
    return false;
  }
  else
  {
...
function validateOfficeHomePlan() {
  ...
  if(cpatchaTextBox1.replace(/\s/g, "").length == 0)
  {
    err++;
    $("#cpatchaTextBox1_msg").html("Please enter your cpatcha");
    return false;
  }
  else
  {
    $('#cpatchaTextBox1_msg').html('');    
  }
  if(cpatchaTextBox1 != code1)
  {
    err++;
    $("#cpatchaTextBox1_msg").html("Invalid Captcha. try Again");
    return false;
  }
  else
  {
...
function validateNewConnection(){
  ...
  if(cpatchaTextBox2.replace(/\s/g, "").length == 0)
  {
    err++;
    $("#cpatchaTextBox2_msg").html("Please enter your cpatcha");
    return false;
  }
  else
  {
    $('#cpatchaTextBox2_msg').html('');    
  }
  if(cpatchaTextBox2 != code2)
  {
    //alert(code2);
    err++;
    $("#cpatchaTextBox2_msg").html("Invalid Captcha. try Again");
    return false;
  }
  else
  {
...
function validateNewConnectionBusiness(){
  ...
  var cpatchaTextBox3=$("#cpatchaTextBox3").val();
  ...
  if(cpatchaTextBox3.replace(/\s/g, "").length == 0)
  {
    err++;
    $("#cpatchaTextBox3_msg").html("Please enter your cpatcha");
    return false;
  }
  else
  {
    $('#cpatchaTextBox3_msg').html('');    
  }
  if(cpatchaTextBox3 != code3)
  {
    //alert(code2);
    err++;
    $("#cpatchaTextBox3_msg").html("Invalid Captcha. try Again");
    return false;
  }
  else
  {
