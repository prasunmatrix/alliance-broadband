            ...
            <div class="modal-body" id="home_new_connection">
              ...
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-md-8" onload="createCaptcha2();">
                  ...
                  <form action="<?php echo site_url();?>/php/newconnection.php" method="post" name="newconnectionfrm" id="newconnectionfrm" onsubmit="return validateNewConnection()" autocomplete="off">
                    ...
                    <div class="form-group" style="margin-bottom:30px;">
                      <div id="captcha2" style="margin-left: 208px;"></div><a href="javascript:void(0);" onclick="createCaptcha2();"><img src="<?php echo get_template_directory_uri();?>/assets/images/refresh.png"></a>
                    </div>
                    <div class="form-group" style="margin-bottom:30px;">
                      <label for="">Enter Captcha</label>
                      <input type="text" name="cpatchaTextBox2" id="cpatchaTextBox2" class="form-control">
                      <span id="cpatchaTextBox2_msg" style="color:red;"></span>
                    </div>  
                    <center>
            ...
            <div class="modal-body" id="business_new_connection" style="display: none;">
              ...
              <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-md-8" onload="createCaptcha3();">
                  ...
                  <form action="<?php echo site_url();?>/php/newconnection_business.php" method="post" name="newconnectionfrm" id="newconnectionfrm" onsubmit="return validateNewConnectionBusiness()" autocomplete="off">
                    ...
                    <div class="form-group" style="margin-bottom:30px;">
                      <div id="captcha3" style="margin-left: 208px;"></div><a href="javascript:void(0);" onclick="createCaptcha3();"><img src="<?php echo get_template_directory_uri();?>/assets/images/refresh.png"></a>
                    </div>
                    <div class="form-group" style="margin-bottom:30px;">
                      <label for="">Enter Captcha</label>
                      <input type="text" name="cpatchaTextBox3" id="cpatchaTextBox3" class="form-control">
                      <span id="cpatchaTextBox3_msg" style="color:red;"></span>
                    </div>  
                    <center>
                      <button type="submit" name="newconnectionSubmit" id="newconnectionSubmit" class="btn popup_btn">Submit</button>
                    </center>             
