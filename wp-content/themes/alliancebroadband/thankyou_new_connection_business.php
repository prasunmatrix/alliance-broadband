<?php
/**
 * Template Name: Thank You New Connection Business
 */
...
<div class="wrapper">
    ...
    <div class="container">
       ...
       <center>
        ...
        <?php
          global $wpdb;
          $id=$_REQUEST['id'];
          $resultConnection = $wpdb->get_results("SELECT ncb.*,cm.city_name,pm.* from wp_newconnection_business as ncb INNER JOIN wp_city_master as cm ON ncb.city_id=cm.id INNER JOIN wp_plan_master as pm ON ncb.plan_id=pm.id WHERE ncb.id='$id'");
          // echo "<pre>";
    ...
    margin-top: 100px;">
                     <div class="date_time_sec" style="    margin: 0 0 ;background: #000;">
          <h5 style="    margin: 0 !important; color:#fff;">Connection Date: <?php echo $resultConnection[0]->connection_date; ?></h5>
            &nbsp;&nbsp;
          <h5 style="    margin: 0 !important; color:#fff;">Connection Time:<?php echo date('h:i:s a', strtotime($resultConnection[0]->connection_time));?></h5>
          &nbsp;&nbsp;
        </div>
