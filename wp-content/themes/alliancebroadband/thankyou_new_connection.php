<?php
/**
 * Template Name: Thank You New Connection
 */
    ...
    <div class="container">
       ...
       <center>
        ...
        <?php
          global $wpdb;
          $id=$_REQUEST['id'];
          $resultConnection = $wpdb->get_results("SELECT nc.*,cm.city_name,pm.* from wp_newconnection as nc INNER JOIN wp_city_master as cm ON nc.city_id=cm.id INNER JOIN wp_plan_master as pm ON nc.plan_id=pm.id WHERE nc.id='$id'");
          // echo "<pre>";
